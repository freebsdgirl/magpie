...
.venv/bin/python -m compileall magpie tests
```
...
gh pr create --repo randileeharper/magpie --base main --head <branch> --title "..." --body "..."
gh issue close <number> --repo randileeharper/magpie --comment "Fixed by #<pr>."
```
